<template>
  <div>
    ...
    <main>
      <div class="texts">
        ...
        <h2 class="_title" data-aos="fade-left" data-aos-duration="800" data-aos-delay="400">
          Aplicações Modernas, do Front-end ao Back-end
        </h2>
        <p class="_p" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800">
          Transformo conceitos em realidade utilizando o ecossistema JavaScript. Sou proficiente em criar experiências de usuário dinâmicas com Vue.js e em construir APIs eficientes e escaláveis com Node.js, entregando produtos completos e modernos.
        </p>
        <div class="buttons">
    ...
    <!-- Slider Section -->
    <div class="_slider bg-color" style="--width: 280px; --height: 56px; --quantity: 6;">
      <div class="list">
        <div class="item" style="--position: 1;"><p>Estudante de EGS</p></div>
        <div class="item" style="--position: 2;"><p>Ecossistema JavaScript</p></div>
        <div class="item" style="--position: 3;"><p>Soluções Escaláveis</p></div>
        <div class="item" style="--position: 4;"><p>Estudante de EGS</p></div>
        <div class="item" style="--position: 5;"><p>Ecossistema JavaScript</p></div>
        <div class="item" style="--position: 6;"><p>Soluções Escaláveis</p></div>
      </div>
    </div>
    ...
    <section class="aboutme" id="aboutme">
      <div class="about">
        ...
        <div class="me">
          ...
          <p class="_p" style="color: var(--color-alt);" data-aos="fade-left" data-aos-duration="800" data-aos-delay="800">
            Estudante de Engenharia de Software e técnico em Desenvolvimento de Sistemas, com foco em programação web. Tenho experiência com JavaScript/TypeScript, Node.js e Vue.js, além de estar em constante aprimoramento. Atualmente estou estudando Flutter. Sou apaixonado por criar interfaces funcionais e desenvolver soluções criativas, como bots para Discord, sempre buscando desafios que unam tecnologia e inovação.
          </p>
    ...
    <!-- Languages Slider -->
    <div class="_slider language-color"
      :style="{
        '--width': '86px',
        '--height': '86px',
    ...
    <section class="contactme" id="contactme">
      <div class="contact">
        <div>
          ...
          <p class="_subtitle" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
            Entre em contato para colaborações, dúvidas ou oportunidades.
          </p>
          <p class="_p" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
            ...
            Você pode me encontrar nas redes sociais ao lado ou enviar um e-mail diretamente para
            <a href="mailto:henrilima.me@outlook.com" class="_link">henrilima.me@outlook.com</a>.
            <br><br>
            Fique à vontade para tirar dúvidas, propor parcerias ou apenas trocar ideias sobre desenvolvimento web e de software.
            <br><br>
